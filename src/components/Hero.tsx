...
const Hero: React.FC = () => {
  ...
  return <section className="relative overflow-hidden w-full bg-zinc-50">
      ...
      <div className="w-full pt-10 pb-16 md:pt-20 md:pb-32 relative rounded-b-[40px] md:rounded-b-[80px] bg-slate-400 py-[224px]">
        ...
        <div className="relative -mb-28 md:-mb-32 px-0">
          <div className="rounded-none sm:rounded-xl p-0 sm:p-6 lg:p-8 shadow-xl bg-white animate-scale-in mx-[119px] my-0">
            <BookingForm />
          </div>
        </div>
      </div>
