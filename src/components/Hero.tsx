...
const Hero: React.FC = () => {
  ...
  return <section className="relative overflow-hidden w-full bg-zinc-50">
      ...
      <div className="w-full pt-10 pb-16 md:pt-20 md:pb-32 relative rounded-b-[40px] md:rounded-b-[80px] bg-white py-[101px]">
        <div className="w-full text-center mb-8 md:mb-12 px-0">
        ...
        <div className="relative -mb-28 md:-mb-32 px-0">
          <div className="rounded-none sm:rounded-xl p-0 sm:p-6 lg:p-8 shadow-xl bg-white animate-scale-in my-0 py-0 mx-0 px-0">
            <BookingForm />
          </div>
        </div>
      </div>
