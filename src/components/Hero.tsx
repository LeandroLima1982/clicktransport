...
const Hero: React.FC = () => {
  ...
  return <section className="relative overflow-hidden w-full bg-slate-50">
      {/* Navy background that extends full width */}
      <div className="absolute inset-0 bg-[#002366] -z-10 w-full" />
      ...
      <div className="w-full pt-10 pb-16 md:pt-20 md:pb-32 relative rounded-b-[40px] md:rounded-b-[80px] bg-white py-[54px]">
        <div className="w-full text-center mb-8 md:mb-12 max-w-[1400px] mx-auto px-4 md:px-6">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 animate-fade-in">
            <span className="block mb-2 text-center font-extrabold text-[#002366] text-5xl">Transporte Executivo</span>
            <span className="block text-[#D4AF37] mt-1 md:mt-2 my-0 text-5xl font-extrabold">Inteligente</span>
          </h1>
          
          <p style={{
          animationDelay: '0.2s'
        }} className="mb-6 md:mb-8 animate-fade-in opacity-90 text-[#2A2A2A] max-w-2xl mx-auto font-light md:text-lg text-base">Conectamos motoristas executivos a empresas offshore,
