...
const BookingForm: React.FC = () => {
  ...
  return <div className="space-y-5">
      ...
      <div className="space-y-4">
        ...
        {tripType === 'roundtrip' && <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-gray-100">
      ...
      <Button onClick={handleBooking} className="w-full rounded-lg mt-6 bg-[#F8D748] hover:bg-[#F8D748]/90 text-black text-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg px-0 mx-0 py-0 my-0">
