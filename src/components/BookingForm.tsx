...
const BookingForm: React.FC = () => {
  ...
  return <div className="pt-6 md:pt-8 pb-7 md:pb-10 bg-gradient-to-b from-[#002366] via-[#002d80] to-[#003399] rounded-t-xl shadow-lg py-0 md:px-[62px] px-[16px] transition-all duration-300 border-t border-blue-300/10">
