...
const BookingForm: React.FC = () => {
  ...
  return (
    <div className="w-full bg-yellow-400 rounded-lg md:rounded-2xl p-5 md:p-8 shadow-md">
      ...
      <div className="space-y-4">
        ...
        {tripType === 'roundtrip' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3 border-t border-amber-300">
            <DateSelector 
              label="Volta quando?" 
              date={returnDate} 
      ...
      <Button 
        ...
        className="w-full rounded-lg mt-6 md:mt-8 text-black text-base md:text-lg font-medium shadow-md hover:shadow-lg h-12 md:h-14 bg-amber-500 hover:bg-amber-400 transition-all duration-300"
      >
