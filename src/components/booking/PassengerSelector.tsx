...
const PassengerSelector: React.FC<PassengerSelectorProps> = ({
  ...
  return <div className="space-y-2">
      ...
      <Select value={value} onValueChange={handleValueChange} open={open} onOpenChange={setOpen}>
        <SelectTrigger className="w-full py-6 rounded-lg border border-gray-100 shadow-sm bg-white focus:border-amber-300 focus:ring-amber-300 text-gray-700">
        ...
        <SelectContent className="max-h-[200px]">
          {passengerOptions.map(num => <SelectItem key={num} value={num} className="cursor-pointer hover:bg-amber-50">
