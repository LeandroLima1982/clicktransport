...
const TripTypeTabs: React.FC<TripTypeTabsProps> = ({
  ...
  return <ToggleGroup type="single" value={value} onValueChange={val => val && onChange(val as 'oneway' | 'roundtrip')} className="p-1 rounded-full bg-yellow-500 py-[5px] mx-[32px] px-[11px] my-[7px]">
