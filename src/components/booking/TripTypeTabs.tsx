...
const TripTypeTabs: React.FC<TripTypeTabsProps> = ({
  ...
  return <ToggleGroup type="single" value={value} onValueChange={val => val && onChange(val as 'oneway' | 'roundtrip')} className="bg-amber-100/60 p-1 rounded-full px-0 py-[6px]">
