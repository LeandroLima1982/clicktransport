...
const TripTypeTabs: React.FC<TripTypeTabsProps> = ({
  ...
  return (
    <TransitionEffect direction="fade" delay={150}>
      <div className="glass-switch rounded-full px-1.5 py-1 border border-amber-200/70 shadow-lg w-full max-w-[180px] md:max-w-[200px] flex justify-center mx-auto animate-float">
        <ToggleGroup 
          type="single" 
          value={value} 
