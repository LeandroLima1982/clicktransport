...
const TripTypeTabs: React.FC<TripTypeTabsProps> = ({
  ...
  return <ToggleGroup type="single" value={value} onValueChange={val => val && onChange(val as 'oneway' | 'roundtrip')} className="p-1 rounded-full px-[6px] py-[6px] bg-amber-400">
