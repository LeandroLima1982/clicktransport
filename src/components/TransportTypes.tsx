    ...
    >
      <div className="max-w-[1400px] mx-auto px-4 w-full md:px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Opções de Transporte</h2>
              ...
              >
                <div 
                  className={`relative h-full overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-500 transform ${
                    activeIndex === index ? 'scale-105 shadow-xl -translate-y-2' : 'scale-100'
                  }`}
                  onMouseEnter={() => {
                    pauseAutoplay();
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      {(hoveredItem === index || activeIndex === index) && (
                        <Button 
                          size="sm" 
